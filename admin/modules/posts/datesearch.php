 		...
 		<div class="col-md-2">
 			<form action="index.php?m=posts&a=datesearch" method="POST">
 			                   <div class="form-group">
 			                       ...
 			                       <input type="date" class="form-control" id="exampleFromDate1" name="from_date" value="<?= $from_date ?>">
 			                   </div>
 			                   <div class="form-group">
 			                       <label for="exampleInputPost1">To</label>
 			                       <input type="date" class="form-control" id="exampleInputPost1" name="to_date" value="<?= $to_date ?>">
 			                   </div>
